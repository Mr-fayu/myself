...
Enjine.DrawableManager.prototype = {
  ...
  RemoveList: function(a) {
    for (var b = 0,
           c = 0,
           c = 0; c < a.length;) for (b = 0; b < this.Objects.length; b++) if (this.Objects[b] === a[c]) {
...
Enjine.Collideable.prototype = {
  ...
  CheckCollision: function(a) { ! (this.Y + this.Height < a.Y) && !(this.Y > a.Y + a.Height) && !(this.X + this.Width < a.X) && !(this.X > a.X + a.Width) && (this.CollisionEvent(a), a.CollisionEvent(this))
  }
};
